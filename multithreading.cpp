...
int main()
{
    ...
    cout << "test_f_normal: " << (end - start) / (double) CLOCKS_PER_SEC << "s" << endl;
    ...
    cout << "test_f_mutex: " << (mend - mstart) / (double) CLOCKS_PER_SEC << "s" << endl;
    ...
    cout << "test_f_atomic: " << (aend - astart) / (double) CLOCKS_PER_SEC << "s" << endl;
